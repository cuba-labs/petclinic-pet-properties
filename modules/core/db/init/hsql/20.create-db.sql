...
alter table PETCLINIC_PET add constraint FK_PETCLINIC_PET_PROPERTIES foreign key (PROPERTIES_ID) references PETCLINIC_PET_PROPERTIES(ID)^
...
alter table PETCLINIC_FLYING_PROPERTIES add constraint FK_PETCLINIC_FLYING_PROPERTIES_ID foreign key (ID) references PETCLINIC_PET_PROPERTIES(ID)^
-- end PETCLINIC_FLYING_PROPERTIES
-- begin PETCLINIC_WATER_PROPERTIES
alter table PETCLINIC_WATER_PROPERTIES add constraint FK_PETCLINIC_WATER_PROPERTIES_ID foreign key (ID) references PETCLINIC_PET_PROPERTIES(ID)^
